...
const Map<String, String> jaJP = {
  ...
  'dyn.anonymous': '匿名',
  'dyn.cancel_fav': '取消收藏',
  'dyn.cancel_top': 'ピン留めを解除',
  'dyn.captain_live': '大航海直播',
  'dyn.check_dynamic': '检查动态',
  'dyn.close_reply': 'コメントを閉じる',
  'dyn.copy_text': '文本',
  'dyn.danmu_count': '弹幕',
  ...
  'dyn.start_featured_reply': 'おすすめコメントを有効化',
  'dyn.stop_featured_reply': 'おすすめコメントを無効化',
  'dyn.temp_block': '临时屏蔽：@name',
  'dyn.temp_block_toast': '已临时屏蔽@name(@mid)，重启恢复',
  'dyn.text_vote': 'テキスト投票',
  'dyn.time': '时间',
  ...
  'live_dm_block.block_enabled': 'ブロック有効',
  ...
  'msg_feed_top.text': ' @var0で自分をメンションしました',
  'msg_feed_top.text_1': 'メンション',
  ...
  'common.level_semantics': 'レベル@level',
  'common.hardcore_level_semantics': 'ハードコアレベル@level',
  'dyn.tab_reply': 'コメント',
  'dyn.tab_reaction': 'いいね・リポスト',
  'live_dm_block.block_disabled': 'ブロック無効',
  'live_dm_block.block_keyword': 'キーワードをブロック',
  'live_dm_block.block_user': 'ユーザーをブロック',
  'danmaku_block.edit_rule': '@typeルールを編集',
  'danmaku_block.add_rule': '新しい@typeルールを追加',
  'net.transform_timeout': 'レスポンスデータの変換がタイムアウトしました！',
  'player.decode_changed': 'デコード形式を @format に変更しました',
  'player.format': '形式：',
  'sponsor_block.category_change_success': 'カテゴリを変更しました',
  'sponsor_block.category_change_failed': 'カテゴリの変更に失敗しました：@error',
  'video.vote_participants': '@count人が参加',
  'video.vote_red_side': '赤側  ',
  'video.vote_blue_side': '青側  ',
  'video.vote_side': '投票  ',
  'video.play_now': '今すぐ再生',
  'video.replay': 'もう一度再生',
  'video.continue_playing': '続きから再生',
  'video.always_on_top': 'ウィンドウを最前面に固定',
  'video.cancel_always_on_top': '最前面への固定を解除',
  'video.enable_danmaku': '弾幕を有効化',
  'video.disable_danmaku': '弾幕を無効化',
  'video.unfavorited_successfully': 'お気に入りから削除しました',
