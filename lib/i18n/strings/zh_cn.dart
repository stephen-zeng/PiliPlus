...
const Map<String, String> zhCN = {
  ...
  'live_dm_block.block_enabled': '屏蔽已开启',
  ...
  'common.level_semantics': '@level级',
  'common.hardcore_level_semantics': '硬核@level级',
  'dyn.tab_reply': '评论',
  'dyn.tab_reaction': '赞与转发',
  'live_dm_block.block_disabled': '屏蔽未开启',
  'live_dm_block.block_keyword': '关键词屏蔽',
  'live_dm_block.block_user': '用户屏蔽',
  'danmaku_block.edit_rule': '编辑@type规则',
  'danmaku_block.add_rule': '添加新的@type规则',
  'net.transform_timeout': '转换响应数据超时！',
  'player.decode_changed': '解码已变为：@format',
  'player.format': '格式：',
  'sponsor_block.category_change_success': '类别更改成功',
  'sponsor_block.category_change_failed': '类别更改失败：@error',
  'video.vote_participants': '@count人参与',
  'video.vote_red_side': '红方  ',
  'video.vote_blue_side': '蓝方  ',
  'video.vote_side': '投票  ',
  'video.play_now': '立即播放',
  'video.replay': '重新播放',
  'video.continue_playing': '继续播放',
  'video.always_on_top': '置顶窗口',
  'video.cancel_always_on_top': '取消置顶窗口',
  'video.enable_danmaku': '开启弹幕',
  'video.disable_danmaku': '关闭弹幕',
  'video.unfavorited_successfully': '取消收藏成功',
