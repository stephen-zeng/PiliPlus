...
class _PLVideoPlayerState extends State<PLVideoPlayer>
                ...
                .map(
                  (double speed) => PopupMenuItem<double>(
                    ...
                    child: Text(
                      "${speed}X",
                      style: const TextStyle(color: Colors.white, fontSize: 13),
                      semanticsLabel: 'player.speed_semantics'.trParams({
                        'speed': '$speed',
                      }),
                    ),
                  ),
                  ...
                  return PopupMenuItem<int>(
                    ...
                    onTap: () async {
                      ...
                      SmartDialog.showToast(
                        'player.quality_changed'.trParams({'desc': newQa.desc}),
                      );
                ...
                child: Obx(
                  () => AnimatedOpacity(
                    ...
                    child: Container(
                      ...
                      child: Obx(
                        () => Text(
                          'player.speed_x'.trParams({
                            'speed':
                                '${plPlayerController.enableAutoLongPressSpeed ? (plPlayerController.longPressStatus.value ? plPlayerController.lastPlaybackSpeed : plPlayerController.playbackSpeed) * 2 : plPlayerController.longPressSpeed}',
                          }),
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 13,
  ...
  Future<void> screenshotWebp() async {
    ...
    SmartDialog.showLoading(
      ...
      builder: (_) =>
          LoadingWidget(progress: progress, msg: 'player.saving_gif'.tr),
      onDismiss: () async {
