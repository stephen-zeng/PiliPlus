          ...
          if (replyControl.showTranslation) {
            ...
            if (res case Success(:final response)) {
              ...
              SmartDialog.showToast(
                'video.translation_failed'.trParams({
                  'var0': (errMsg).toString(),
                }),
              );
            }
            isProcessing = false;
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: 'video.total_replies'.trParams({
                            'var0': (replyItem.count).toString(),
                          }),
                          style: TextStyle(
              ...
              recognizer: isValid
                  ? (NoDeadlineTapGestureRecognizer()
                      ..onTap = () {
                        ...
                        try {
                          SmartDialog.showToast(
                            'video.jump_to'.trParams({
                              'var0': (matchStr).toString(),
                            }),
                          );
            ...
            ListTile(
              onTap: () async {
                ...
                if (res.isSuccess) {
                  ...
                  SmartDialog.showToast(
                    'video.delete_failed'.trParams({'var0': (res).toString()}),
                  );
                }
              },
              minLeadingWidth: 0,
