...
class HeaderControl extends StatefulWidget {
  ...
  static Future<void> reportDanmaku(
    ...
    if (Accounts.main.isLogin) {
      ...
      return SmartDialog.showToast('music.not_logged_in'.tr);
    }
  }
                      ...
                      Obx(
                        () {
                          ...
                          return ActionRowLineItem(
                            ...
                            text: 'video.flip_left_and_right'.tr,
                            selectStatus: flipX,
                          );
                        },
                      ),
                      Obx(
                        () {
                          ...
                          return ActionRowLineItem(
                            ...
                            text: 'video.flip_up_and_down'.tr,
                            selectStatus: flipY,
                          );
                        },
                      ),
                      ...
                      if (PlatformUtils.isMobile)
                        Obx(
                          () => ActionRowLineItem(
                            ...
                            text: 'video.play_in_background'.tr,
                  ...
                  child: SizedBox(
                    ...
                    child: GestureDetector(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('player.select_quality'.tr, style: titleStyle),
                          Icon(
                            Icons.info_outline,
                            size: 16,
              ...
              slivers: [
                SliverToBoxAdapter(
                  child: SizedBox(
                    height: 45,
                    child: Center(
                      child: Text('player.audio_quality'.tr, style: titleStyle),
                    ),
                  ),
                ),
                SliverList.builder(
              ...
              if (!isFileSource) ...[
                ...
                if (plPlayerController.enableSponsorBlock)
                  SizedBox(
                    ...
                    height: btnHeight,
                    child: IconButton(
                      tooltip: 'video.submit_snippet'.tr,
                      style: btnStyle,
