...
class _SharePanelState extends State<SharePanel> {
  ...
  Future<void> _onSend() async {
    ...
    if (list.isEmpty) {
      SmartDialog.showToast('share.select_user'.tr);
      return;
    }
    ...
    if (res.every((e) => e)) {
      Get.back();
      SmartDialog.showToast('share.success'.tr);
    } else if (res.every((e) => !e)) {
      SmartDialog.showToast('share.failed'.tr);
    } else {
      SmartDialog.showToast('share.partial_failed'.tr);
    }
  }
}
